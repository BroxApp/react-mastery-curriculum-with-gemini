...
| :-------- | :----------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| 5/9/2026 | Custom Hooks Exercise 2 - useFetch Implementation & Practice | feat: implement custom useFetch hook with data, loading, error, and refetch states; handle API requests, HTTP errors, loading lifecycle, and manual refetching; practice side effects and network request management with useEffect |
...
- [ ] Resume & Profile Optimization (Upwork/Fiverr)
